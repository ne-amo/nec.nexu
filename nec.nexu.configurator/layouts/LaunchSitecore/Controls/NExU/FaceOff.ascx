<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FaceOff.ascx.cs" Inherits="nec.nexu.configurator.NExU.FaceOff" %>
    ...
    <link href="/assets/css/nexu.faceoff.css" rel="stylesheet" />



    <div class="nx-faceoff-container row transparent">

        <div class="nx-faceoff-circles  hidden-xs">
            <div class="nx-circle-container nx-left col-xs-6">
                <div class="nx-circle"
                    data-bind="attr: { data-total: FinishedProductAVoteCount, data-percentage: PercentageA, data-bg:FinishedProductABackgroundColor }">
                    &nbsp;
                </div>
            </div>
            ...
            <div class="nx-circle-container nx-right col-xs-6">
                <div class="nx-circle"
                    data-bind="attr: { data-total: FinishedProductBVoteCount, data-percentage: PercentageB, data-bg:FinishedProductBBackgroundColor}">
                    &nbsp;
                </div>
            </div>
        </div>
    ...
    <script src="/assets/kendo/js/kendo.custom.js"></script>
