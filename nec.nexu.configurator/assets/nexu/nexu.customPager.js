/*
* Custom pager based on the stock Kendo UI pager. Added optional "Page {0} of {1}".
*/
(function () {
                ...
                try{
                    ...
                    if (options.info) {
                        if (!that.element.find(".k-pager-info").length) {
                            that.element.prepend('<span class="k-pager-info k-label" />');
                        }
                    }
